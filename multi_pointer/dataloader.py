...
class NERDataLoader(object):
    ...
    def collate_fn(features):
        ...
        tensors = [input_ids, input_mask, gold_start, gold_end, split_to_ori, example_ids]
        return tensors
...
if __name__ == '__main__':
    ...
    print(len(feats))
    print(feats[11].input_ids)
    print(feats[12].input_ids)
    print(feats[11].split_to_original_id)
    print(feats[12].split_to_original_id)
